...
- Log into the Cloud Console and select Autonomous Data Warehouse from the hamburger menu

  ![](./images/2/013temp.png  " ")


- Select your database ADW, and then the ADWC Service Console.

  ![](./images/2/015temp.png  " ")

  ![](./images/2/016temp.png  " ")
